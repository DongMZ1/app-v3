...
const QuoteSummaryRental = () => {
    ...
    return <div className='flex flex-col w-full h-full px-6 py-4 overflow-y-auto quote-summary-rental'>
        <div className='flex'>
            ...
            {
                editable && <>
                    <div className='flex h-full px-4 ml-auto border border-black border-solid '><div className='m-auto'>Start Date</div></div>
                    <div className='relative flex px-4 bg-white border border-black border-solid'>
