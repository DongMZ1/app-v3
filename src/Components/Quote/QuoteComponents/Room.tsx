...
const Room = ({eachRoom}:RoomType) => {
    ...
    return <div className='w-full mt-6'>
        <FurnitureInRoomHeader deleteRoom={() => deleteRoom()} addItemList={[]} roomNumber={eachRoom?.count} onRoomNumberChange={(v) => updateRoomCount(v)} roomName={eachRoom?.roomType} editable={userRole !== 'viewer'}>
            <>
            </>
