...
const NoteModal = ({ text, onChange, onClose, save, show, unitName }: NoteModalProps) => {
    return <Popup boxShadow={false} show={show} onClose={onClose}>
        <div className='border border-black border-solid w-96 bg-cream note-modal'>
            ...
            <div className='flex my-4'>
                <Button onClick={onClose? ()=>onClose() : ()=>{}} className='justify-center w-20 ml-auto'>Cancel</Button>
