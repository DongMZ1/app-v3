...
const CatalogueFilterRoomAndStyle = ({ setshowRoomsAndStyle }: CatalogueFilterRoomAndStyleProp) => {
    const filterCatalogue = useSelector((state: Tappstate) => state.filterCatalogue);
    const [roomsAndStyleRoom, setroomsAndStyleRoom] = useState<string[]>(filterCatalogue?.roomsAndStyleRoom ? filterCatalogue?.roomsAndStyleRoom : []);
    const [roomsAndStyleCollections, setroomsAndStyleCollections] = useState<string[]>(filterCatalogue?.roomsAndStyleCollections? filterCatalogue.roomsAndStyleCollections : []);
