...
const StartNewProject = () => {
    ...
    return <div className='w-screen h-screen overflow-auto start-new-project bg-cream'>
        <div className='flex bg-white border border-black border-solid h-14'>
            <Link className='flex bg-black w-14' to='/'><AiOutlineArrowLeft color='white' size={22} className='m-auto' /></Link>
        </div>
        <div className='flex mt-4 '>
            <div className='p-4 mx-auto bg-white border border-black border-solid start-new-project-form'>
